...
@JvmOverloads
fun CoerceUtils.asJavaBigInteger(v: Any?, defaultValue: BigInteger? = null): BigInteger? = when (v) {
    null -> defaultValue
    is BigInteger -> v
    ...
    else -> throw NumberFormatException(jvmErrorMessage(v))
}

// :: BigDecimal (java.math)

@JvmOverloads
fun CoerceUtils.asJavaBigDecimal(v: Any?, defaultValue: BigDecimal? = null): BigDecimal? = when (v) {
    null -> defaultValue
    is BigDecimal -> v
...
@JvmOverloads
fun CoerceUtils.asJavaNumber(v: Any?, defaultValue: Number? = null): Number? = when {
    v == null -> defaultValue
    v is Number -> v
    defaultValue == null -> asJavaBigDecimal(v)
    ...
    defaultValue is BigInteger -> asJavaBigInteger(v, defaultValue)
    defaultValue is BigDecimal -> asJavaBigDecimal(v, defaultValue)
    else -> throw NumberFormatException(jvmErrorMessage(v))
}
...
@JvmOverloads
fun CoerceUtils.asJavaDate(v: Any?, defaultValue: java.util.Date? = null): java.util.Date? = when (v) {
    null -> defaultValue
    is java.util.Date -> {
    ...
    else -> throw IllegalArgumentException(jvmErrorMessage(v))
}

// :: java.sql.Timestamp

@JvmOverloads
fun CoerceUtils.asJavaTimestamp(v: Any?, defaultValue: java.sql.Timestamp? = null): java.sql.Timestamp? = when (v) {
    null -> defaultValue
...
@JvmOverloads
fun CoerceUtils.asJavaSqlDate(v: Any?, defaultValue: java.sql.Date? = null): java.sql.Date? = when (v) {
    null -> defaultValue
    is java.sql.Date -> v
...
@JvmOverloads
fun CoerceUtils.asJavaLocalDate(v: Any?, defaultValue: LocalDate? = null): LocalDate? = when (v) {
    null -> defaultValue
    is LocalDate -> v
...
@JvmOverloads
fun CoerceUtils.asJavaLocalDateTime(v: Any?, defaultValue: LocalDateTime? = null): LocalDateTime? = when (v) {
    null -> defaultValue
    is LocalDateTime -> v
...
@JvmOverloads
fun CoerceUtils.asJavaLocalTime(v: Any?, defaultValue: LocalTime? = null): LocalTime? = when (v) {
    null -> defaultValue
    is LocalTime -> v
...
@JvmOverloads
fun CoerceUtils.asJavaOffsetDateTime(v: Any?, defaultValue: OffsetDateTime? = null): OffsetDateTime? = when (v) {
    null -> defaultValue
    is OffsetDateTime -> v
...
@JvmOverloads
fun CoerceUtils.asJavaZonedDateTime(v: Any?, defaultValue: ZonedDateTime? = null): ZonedDateTime? = when (v) {
    null -> defaultValue
    is ZonedDateTime -> v
...
@JvmOverloads
fun CoerceUtils.asByteArrayFromHex(v: Any?, defaultValue: ByteArray? = null): ByteArray? = when (v) {
    null -> defaultValue
    is ByteArray -> v
...
@JvmOverloads
fun CoerceUtils.asJavaByteArray(v: Any?, defaultValue: ByteArray? = null): ByteArray? = when (v) {
    null -> defaultValue
    is ByteArray -> v
    is Byte -> byteArrayOf(v)
...
private fun jvmErrorMessage(v: Any): String = "The value cannot be parsed to: '${v.javaClass}'"
