#!/usr/bin/env bash
#
# deploy.sh — Build and deploy the Shopping Compose Android app
#
# Usage:
...
APP_ID="br.com.wdc.shopping.android"
GRADLE_MODULE=":view-compose-android"
...
echo ""
echo "╔══════════════════════════════════════════════════╗"
echo "║   Shopping Compose Android — Deploy             ║"
echo "╠══════════════════════════════════════════════════╣"
printf "║  Target:       %s\n" "$TARGET"
printf "║  Build:        %s\n" "$BUILD_TYPE"
if [[ "$TARGET" == "emulator" ]]; then
