...
include(":view-remote-react-skeleton")
...
include(":view-native-web-worker")
...
project(":view-native-web-worker").projectDir  = file("br.com.wdc.kt.shopping/br.com.wdc.kt.shopping.view.native/native.web.worker")
