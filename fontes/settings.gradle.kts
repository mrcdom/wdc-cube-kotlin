...
project(":view-compose-web").projectDir        = file("br.com.wdc.kt.shopping/br.com.wdc.kt.shopping.view.compose/web")
project(":view-compose-ios").projectDir        = file("br.com.wdc.kt.shopping/br.com.wdc.kt.shopping.view.compose/ios")
project(":view-compose-android").projectDir    = file("br.com.wdc.kt.shopping/br.com.wdc.kt.shopping.view.compose/android")
project(":view-compose-desktop").projectDir    = file("br.com.wdc.kt.shopping/br.com.wdc.kt.shopping.view.compose/desktop")
